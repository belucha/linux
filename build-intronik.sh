...
export BUILD=intronik1.0
export DISTRO=cross
export DEBARCH=armhf
export ARCH=arm
export config="intronik_defconfig"
export CC=${DIR}/bb-kernel/dl/gcc-linaro-arm-linux-gnueabihf-4.9-2014.08_linux/bin/arm-linux-gnueabihf-
export KERNEL=${DIR}/bb-kernel/KERNEL
export DEPLOY=${DIR}/intronik-deploy
export KERNEL_REL=3.14
export KERNEL_TAG=${KERNEL_REL}-rc2
# actual script
